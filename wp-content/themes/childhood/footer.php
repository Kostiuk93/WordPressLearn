<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="215" title="Popup"]') ?>
            </div>
        </div>
        <footer>
            <div class="container">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBUx_mfZF3n_oT4WMhc0MvmuojMPw0iXBc"></script> 
