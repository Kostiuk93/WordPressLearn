...
?>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php the_field('toys_title', 2);?></h2>
                        ...
                        foreach( $my_posts as $post ){
                            ...
                            <div class="toys__item" style="background-image: url(<?php 
                                ...
                                <div class="toys__item-info">
                                    ...
                                    <div class="minibutton toys__trigger"><?php the_field('toys_btn', 2);?></div>
                                </div>
                            </div>
                            <?php
                        }
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('toys_alertBold', 2);?></span> <?php the_field('toys_alert', 2);?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title"><?php the_field('contacts_title', 2); ?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                        <?php the_field('contacts_address', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('mobile_base', 2); ?>"><?php the_field('mobile_base', 2); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('mobile_additional', 2); ?>"><?php the_field('mobile_additional', 2); ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="210" title="Форма отзывов"]') ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
...
<?php 
    ...
    add_action('my_hook', 'print_hello1', 6);
    add_action('my_hook', 'print_hello2', 5);

    do_action('my_hook', 'dear customer', 'Alex');
